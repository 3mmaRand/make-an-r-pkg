...
author: "Emma Rand"
date: "<br>🔗 [bit.ly/3mma-pkg](https://bit.ly/3mma-pkg)"
format:
  revealjs: 
...
-   How to make a minimal documented package and check it using the
    `devtools`[@wickham2021] approach
-   Components of a minimal package

::: aside
Based on [R Packages](https://r-pkgs.org/) [@wickham2020], Data Science
for Modern and Open Research: You can make an R package too!
[@rand2021], [Forwards Package development
modules](https://github.com/forwards/workshops) [@rand]
:::
...
-   Required packages specified in `DESCRIPTION`, made available in
    `NAMESPACE` file
...
Note: this is **not** the same as your working directory or your home
directory.
...
-   `mypackage.Rproj` is the file that makes this directory an RStudio
    Project.
